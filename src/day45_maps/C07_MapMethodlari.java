...
public class C07_MapMethodlari {
    public static void main(String[] args) {
        ...
        /*
         eger value birleştirilmiş bir String ise Ali-Can-11-H-MF, gibi
         harfler.containsValue("Ali") diye aratırsak false döner çünkü parçasına değil tamamına bakar equals gibi
         */
